...
public class JwtTokenFactory : IJwtTokenFactory
{
    ...
    public JwtTokenFactory(JwtTokenValidationParamsFactory jwtJwtTokenParamsFactory) =>
        _jwtJwtTokenParamsFactory = jwtJwtTokenParamsFactory ??
                                    throw new ArgumentNullException(nameof(jwtJwtTokenParamsFactory));
    ...
    private SecurityTokenDescriptor CreateDescriptor(IEnumerable<Claim> claims, int expirationHours,
